...
from src.subdags import product_download_etl 
...
download_operators = product_download_etl.cj_download.get_operators(dag)
embeddings_operators = product_download_etl.new_product_embeddings.get_operators(dag)
postgre_export_operators = product_download_etl.postgre_export.get_operators(dag)
